...
# ============================================================
def run_simulation(base_tasks, procs, sim_ticks, mig_mode, switch_prob):
...
def main():
    ...
    with open(csv_file_path, mode='w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(["m", "Prob", "Total_Jobs", 
            ...
            for prob in probs:
                ...
                for task_set in schedulable_sets:
                    for mode in ["off", "single", "chain"]:
                        ...
                        t_total, d_total = run_simulation(task_set, procs_run, sim_ticks, 
                                                          mig_mode=mode, switch_prob=prob)
                ...
                if acc["off"]["total"] > 0:
                    ...
                    writer.writerow([m, prob, acc["off"]["total"], r_off, r_single, r_chain])
                    print(f"Prob={prob:.1f} -> OFF={r_off:.2f}%, Single={r_single:.2f}%, Chain={r_chain:.2f}%")
